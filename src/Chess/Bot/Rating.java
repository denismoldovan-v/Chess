...
/**
 * Klasa używana przez bota do określenia najlepszego ruchu.
 * @author Logic Crazy Chess
 */
public class Rating {
    final static int[][] pawnBoard ={//attribute to http://chessprogramming.wikispaces.com/Simplified+evaluation+function
        { 0,  0,  0,  0,  0,  0,  0,  0},
    ...
    private static int rateMoveablitly(int listLength, int depth) {
        int counter=0;
